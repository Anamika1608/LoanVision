...
const environmentVariableSchema = z.object({
  ...
  POSTGRES_POOL_MAX_SIZE: z.coerce.number().gte(1),
  POSTGRES_IDLE_TIMEOUT_IN_MS: z.coerce.number().gte(1000),
  POSTGRES_CONN_TIMEOUT_IN_MS: z.coerce.number().gte(1000),
  ...
  REDIS_MAX_CONNECTION_RETRY: z.coerce.number().positive().int(),
  REDIS_MIN_CONNECTION_DELAY_IN_MS: z.coerce.number().positive().int(),
  REDIS_MAX_CONNECTION_DELAY_IN_MS: z.coerce.number().positive().int(),
  ...
  WINDOW_SIZE_IN_SECONDS: z.coerce.number().gte(30),
  MAX_NUMBER_OF_REQUESTS_AUTH_USER_PER_WINDOW_SIZE: z.coerce.number().gte(1),
  MAX_NUMBER_OF_REQUESTS_NOT_LOGGEDIN_USER_PER_WINDOW_SIZE: z.coerce.number().gte(1)
});
